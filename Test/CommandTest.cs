...
namespace NShapeTest {
	...
	[TestClass]
	public class CommandTest : NShapeTestBase
	{
		...
		public void CommandTest_ShapeMovement() {
			...
			// Create project, diagram, shapes, ...
			Project project = CreateProject(projectName, true, true);
			Diagram diagram = new Diagram(diagramName);
			List<Shape> shapes = CreateShapes(project);
		...
		private Project CreateProject(string projectName, bool create) {
			return CreateProject(projectName, create, false);
		}


		private Project CreateProject(string projectName, bool createNewProject, bool createTemplates) {
			Project project = new Project();
			project.Name = projectName;
			project.AutoLoadLibraries = true;
			project.AutoGenerateTemplates = createTemplates;
